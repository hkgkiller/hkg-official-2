module.exports = {
    ...
    token: "ODExMTU3NTU1ODA3NzgwODg0.YCuHVw.S6aOfJtD-P9JgwrDfIEqbJDEtz0",
    /* For the support server */
    support: {
        id: "811163125558018078", // The ID of the support server
    ...
    prefix: "hkg!", // The default prefix for the bot
    /* For the embeds (embeded messages) */
    embed: {
        color: "#0091fc", // The default color for the embeds
        footer: "HKG OFFICIAL | Open Source" // And the default footer for the embeds
    },
    /* Bot's owner informations */
    owner: {
        id: "706522217520824320", // The ID of the bot's owner
        name: "𝕋𝔾乂 •KILLER#0001" // And the name of the bot's owner
    },
    ...
    /* The Bot status */
    status: [{
            name: "@HKG OFFICIAL help on {serversCount} servers",
            type: "LISTENING"
        },
        {
            name: "HKG KILLER ON YOUTUBE",
            type: "WATCHING"
        }
    ]
};